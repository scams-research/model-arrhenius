...
Fitting offers several benefits over presenting raw data alone.
These benefits may be qualitative, such as interpolating a smooth curve to reveal trends obscured in raw data; or quantitative, such as predicting transport coefficients outside the measured regime, or providing fitted parameters (e.g., activation energies) that can be used to compare different materials.
...
\begin{equation}
    ...
    \label{eqn:arrhenius}
\end{equation}
Both equations can be linearised by taking logarithms, and it is common to plot the natural logarithm of $D^*$ or $\sigma T$ against inverse temperature: this representation is known as an ``Arrhenius plot''.
