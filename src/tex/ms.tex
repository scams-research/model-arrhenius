...
Such extrapolations assume the model remains valid in the new regime, and for the extrapolated estimates to be meaningful, the uncertainties in the fitted parameters must be propagated correctly into the predicted values. 
