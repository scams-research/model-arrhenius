...
Fitting offers several benefits over presenting raw data alone: it allows us to interpolate a smooth curve to reveal trends obscured by noise, to predict transport coefficients outside the measured regime, or to extract fitted parameters, such as activation energies, that can be used to compare different materials or explain microscopic dynamics~\cite{Canepa2022, Wang2021}.
