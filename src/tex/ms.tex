...
Bayesian model selection provides a robust approach to rationally comparing different analytical models, and we discuss this in Section~\ref{sec:model}.
...
We would like to thank the original authors of the \ce{AgCrSe2} work for kindly providing simulation trajectories.
