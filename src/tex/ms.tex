...
This assumption of normally distributed data is often reasonable on two grounds.
First, the central limit theorem: if errors arise from many independent sources, their sum will tend toward a normal distribution.
Second, the principle of maximum entropy: if we know only the mean and variance of our errors, the normal distribution assumes the least additional structure.
