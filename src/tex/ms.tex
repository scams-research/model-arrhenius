...
This general framework may be applied to any transport data, such as diffusion coefficients, viscosities, or thermal conductivities, provided the data have accurate uncertainty estimates.
