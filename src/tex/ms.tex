...
Rather than returning a single parameter estimate, Bayesian posterior sampling generates samples from the distribution of parameter values that are compatible with the observed data. 
