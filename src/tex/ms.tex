...
The data come from simulations at four temperatures (\qtylist{500; 600; 700; 800}{\kelvin}), giving us four conductivity estimates with associated uncertainties obtained via an approximate Bayesian regression scheme~\cite{McCluskey2024a}.
